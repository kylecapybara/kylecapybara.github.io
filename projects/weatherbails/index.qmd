...
subtitle: Using data from the city of Philadelphia about bails and weather to investigate their relationship with common classification and regression algorithms.
...
::: {.project-meta}
**Type:** Coursework analysis<br>
**Tools:** Python, pandas, scikit-learn, seaborn<br>
**Output:** Classification and regression experiments using Philadelphia bail and weather data
:::
